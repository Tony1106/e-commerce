...
class AddProductToCart extends Component {
  ...
  componentWillMount() {
    let selectedProduct = this.props.productsInStock.find(
      product => this.props.productName === product.name
    );
      ...
      <React.Fragment>
        <div className={classes.AddProductToCart}>
          {this.state.selectedProduct ? (
            <Form>
              <img
                src={this.state.selectedProduct.imageURL}
                alt="Product"
                width="70%"
              />
              ...
              <Button
                disabled={
                  ...
                  this.state.selectedProduct.size == ""
                }
                color="green"
                fluid
                onClick={() => {
        ...
        <BackDrop
          show={this.state.selectedProduct}
